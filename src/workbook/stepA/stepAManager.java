...
public class stepAManager {
	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			switch(menu) {
			case 1: 				
				stepA_1 step = new stepA_1();
				step.printAge();
				break;
			case 2: 				
				stepA_2 step2 = new stepA_2();
				step2.printDegree();
				break;
			case 3: 				
				stepA_3 step3 = new stepA_3();
				step3.printArea();
				break;
			case 4: 				
				stepA_4 step4 = new stepA_4();
				step4.printArea();
				break;
			case 5: 				
				stepA_5 step5 = new stepA_5();
				step5.printSeconds();
				break;
			case 6: 				
				stepA_6 step6 = new stepA_6();
				step6.printScore();
				break;
			case 7: 				
				stepA_7 step7 = new stepA_7();
				step7.printBytes();
				break;
			}
		}
